...
class GPUTableRenderer(QOpenGLWidget, QOpenGLFunctions):
    ...
    def initializeGL(self):
        ...
        try:
            ...
            glClearColor(
                self.bg_color.redF(), self.bg_color.greenF(), self.bg_color.blueF(), 1.0
            )
    ...
    def _detect_hardware(self):
        ...
        try:
            if OPENGL_AVAILABLE:
                ...
                self.hardware_info = {"opengl_available": False, "fallback_mode": True}
    ...
    def get_acceleration_report(self) -> Dict[str, Any]:
        ...
        if self.gpu_table_renderer:
            report["performance_stats"] = (
                self.gpu_table_renderer.get_performance_stats()
            )
...
if __name__ == "__main__":
    ...
    if gpu_manager.gpu_available:
        ...
        if gpu_table:
            ...
            # Add test data
            test_data = [[f"Row {i} Col {j}" for j in range(5)] for i in range(100)]
